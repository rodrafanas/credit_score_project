...
def preprocess(loan_amnt, term, home_ownership, emp_length, annual_inc, dti, mths_since_recent_inq, addr_state, bc_open_to_buy, num_op_rev_tl):
    ...
    # st.dataframe(user_input)
    return user_input, user_input_original

#user_input=preprocess
user_input, user_input_original = preprocess(loan_amnt, term, home_ownership, emp_length, annual_inc, dti, mths_since_recent_inq,addr_state, bc_open_to_buy, num_op_rev_tl)
...
if btn_predict:
    ...
    explanation = shap.Explanation(
        ...
        data=user_input_original.values[0],
        feature_names=user_input_original.columns  # Nomes das features
    )
